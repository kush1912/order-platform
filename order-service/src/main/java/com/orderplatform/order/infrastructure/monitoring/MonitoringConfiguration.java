package com.orderplatform.order.infrastructure.monitoring;
...
public class MonitoringConfiguration {
     ...
     *   <li>Spring {@code @Scheduled} task polling (e.g. the 500ms outbox poller) which
     *       otherwise emits a single-span trace on every empty poll.</li>
     * </ul>
